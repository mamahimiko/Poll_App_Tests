...
import PollTabs from "@/app/components/PollTabs";
...
describe("Poll tabs", () => {
  ...
  it("marks the active poll's tab as selected", () => {
    ...
    expect(screen.getByRole("tab", { name: /best villain/i })).toHaveAttribute(
      "aria-selected",
      "true",
    );
    expect(
      screen.getByRole("tab", { name: /strongest avenger/i }),
